...
$data = array('id' => 'sub');
echo form_open('site/login/auth', array('id' => 'loginForm'));

$remember = form_checkbox('remember', '1');
$submit = form_submit('submit', 'ورود', $data);
?>

<h1 id="litheader">ورود با کاوشگر</h1>
...
<div class="inset">
    ...
    <p>
        ...
        echo form_password(array(
            ...
            'data-validation-error-msg' => "لطفا پسورد را به درستی وارد نمایید",
            'value' => $pass
        )); ?>
    </p>
...
<div class="inset">
    ...
    <div id="captcha"></div>
    <br>
    <a href="#" style="color: red" onclick="return CreateCaptcha();">refresh captcha</a>
...
<script type="text/javascript">
    ...
    function CreateCaptcha() {
        $.get("<?php echo base_url();?>site/captcha/create", '', function (data) {
            $('#captcha').html(data);
        });
    }
